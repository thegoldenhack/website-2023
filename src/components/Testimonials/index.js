    ...
    render() {
      return <Container><Col xs="auto">
        ...
        <div className="testimonial-box">
          <Testimonial image="/images/testimonials/kyle.JPG" quotee="Keyle Atwood, attendee" body="It was great to see so many people passionate about designing interesting projects! Everyone was willing to help each other, including people from other teams, providing a great sense of community"></Testimonial>
